...
function PostsComponent() {
  ...
  const handlePrefetch = async () => {
    try {
      ...
      // noop - prefetch errors can be non-fatal for demo
    }
  };
  ...
  return (
    <div style={{ padding: 12, border: '1px solid #eee', marginTop: 12 }}>
      ...
      <div style={{ marginBottom: 8 }}>
        ...
        <button onClick={handlePrefetch} style={{ marginRight: 8 }}>Prefetch</button>
        <button onClick={handleInvalidate} style={{ marginRight: 8 }}>Invalidate Cache</button>
        <button onClick={handleRemove} style={{ marginRight: 8 }}>Remove Cache</button>
      </div>
